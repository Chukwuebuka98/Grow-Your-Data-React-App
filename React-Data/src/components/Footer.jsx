    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 ">
      <div>
        ...
        <p className="py-4">
          ...
          harum numquam qui porro perspiciatis, blanditiis nam officia
          perferendis aliquam, minus adipisci sapiente illo accusamus quos
          ipsum. Temporibus, laborum deserunt.
        </p>
